              ...
              <div className="bg-white rounded-md shadow-sm p-4">
                ...
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['bg-black', 'bg-blue-500', 'bg-red-500', 'bg-green-500', 'bg-yellow-500', 'bg-purple-500'].map((color, index) => (
                      <button 
                        key={index}
                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-2">
                    {['Até R$50', 'R$50 a R$100', 'R$100 a R$200', 'Acima de R$200'].map((priceRange) => (
                      <label key={priceRange} className="flex items-center text-sm">
                        <input 
                          type="radio" 
                          name="price" 
              ...
              {loading ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  {products.map((product) => (
                    <div key={product.id} className="bg-white rounded-md shadow-sm overflow-hidden relative">
                      {product.isOnSale && (
